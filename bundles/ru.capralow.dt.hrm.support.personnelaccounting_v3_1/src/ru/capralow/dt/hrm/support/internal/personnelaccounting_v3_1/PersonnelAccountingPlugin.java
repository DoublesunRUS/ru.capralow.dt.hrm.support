...
public class PersonnelAccountingPlugin
    extends Plugin
{
    public static final String ID = "ru.capralow.dt.hrm.support.personnelaccounting_v3_1"; //$NON-NLS-1$

    private static PersonnelAccountingPlugin instance;
    ...
    public static PersonnelAccountingPlugin getInstance()
    {
        return instance;
    }
